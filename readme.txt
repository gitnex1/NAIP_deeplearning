...
================================
-NAIP_STANDALONE 
-run_NAIP_STANDALONE.sh (shell script for temporarily setting environment variables and 
                         executing the application)
   -to run the shell script, type
   
       ./run_NAIP_STANDALONE.sh <mcr_directory> <argument_list>
    ...
    /mathworks/home/application/v80, run the shell script as:
       ...
       ./run_NAIP_STANDALONE.sh /mathworks/home/application/v80
       
    If you have MATLAB installed in /mathworks/devel/application/matlab, 
    run the shell script as:
    
       ./run_NAIP_STANDALONE.sh /mathworks/devel/application/matlab
-MCRInstaller.zip
